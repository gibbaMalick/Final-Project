							...
							<div id="userAddFormContainer">
									<form action="database/add.php" method="POST" class="appForm">
										...
										<div class="appFormInputContainer">
											...
											<input type="password" name="password" class="appFormInput" id="password">
										</div>
										...
										<tbody>
											<?php foreach($users as $index => $user){ ?>
												<tr>
													...
													<td><?= date('M-d-Y @ h:i:s A', strtotime($user['created_date'])) ?></td>
													<td><?= date('M-d-Y @ h:i:s A', strtotime($user['updated_date'])) ?></td>
													<td>
			...
			document.addEventListener('click', function(e){
				...
				if(classList.contains('deleteUser')){
					...
					BootstrapDialog.confirm({
						...
						btnCancelLabel: 'Cancel', // Set the label for the Cancel button
        				btnOKLabel: 'Delete',    // Set the label for the OK button
					...
					BootstrapDialog.confirm({
						...
						message: '<form>\
							...
							callback: function(isUpdate){
						        if(isUpdate){  // Check if the user clicks the 'OK' button
						            $.ajax({
						                method: 'POST',
						                data: {
						                    userId: userId,
